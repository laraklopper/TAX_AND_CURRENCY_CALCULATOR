...
| GET |/fetchUsers| Fetch all users ||
| PATCH | /editUser | update user details | Yes ||
| PATCH |/editPassword | Edit user password |Yes| |
| DELETE | /deleteUser/:id | Delete a user (admin only) ||
