...
/* VAT is NOT served from here. It was drafted in this file as a `calculateVat`
handler that was never attached to a route, which left the SARS rate written
down in a second place that nothing called. The maths now lives in
utils/vatCalculator.js and is served by routes/vatRoutes.js at /vat, alongside
the /save and /history routes a saved VAT calculation needs - VAT resolves no
tax year, so it shares nothing with the routes above. */
