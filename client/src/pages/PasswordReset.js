...
export default function PasswordReset() {
  ...
  return (
    ...
    with 'RESET PASSWORD' as the resetPswdHeading */}
        <ResetPswdHeader resetPswdHeading='RESET PASSWORD'/>
        <section id='reset-password-section'>
            <Row id='reset-password-row'>
                <Col xs={0}  id='forgot-password-col1' />
                ...
                <Col xs={0} id='forgot-password-col2' />
            </Row>
        </section>
        <PageFooter/>
    </div>
